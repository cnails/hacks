...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.go_to_chats.setGeometry(QtCore.QRect(10, 160, 71, 61))
        self.go_to_chats.setObjectName("go_to_chats")
        self.go_to_files = QtWidgets.QPushButton(self.centralwidget)
        self.go_to_files.setGeometry(QtCore.QRect(10, 250, 71, 61))
        ...
        self.name_chat.setGeometry(QtCore.QRect(320, 15, 81, 21))
